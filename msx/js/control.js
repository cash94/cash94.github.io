...
function setupFocusRescue() {
    ...
    function getColumns() { var g = getEl('torrents-grid'); if (!g) return 6; try { return (getComputedStyle(g).gridTemplateColumns || '').split(' ').filter(function (b) { return b; }).length || 6; } catch (e) { return 6; } }
